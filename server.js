...
// // ✅ FIXED: Vercel ke liye 'polling' bilkul band kar dein aur sirf 'websocket' use karein
...
//   },
//   transports: ['websocket'], // 🔥 CRITICAL FIX: Polling hata di, sirf websocket rakha hai
//   allowEIO3: true 
// });
...
// ✅ FIXED FOR VERCEL: Polling completely removed, only websocket allowed
const io = socketio(server, {
  cors: { 
    origin: ALLOWED_ORIGINS, 
    credentials: true,
  ...
  transports: ['websocket'], // Direct WebSocket connection without polling handshake
  allowEIO3: true 
});
